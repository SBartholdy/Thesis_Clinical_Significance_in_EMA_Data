...
#save(PP_1.1, file = "cor_07_k62/PP_1.1.RData")
#load("cor_07_k62/PP_1.1.RData") #< einzelnes 1.1-dataset nur für pre-post-plot nötig
...
PP_5.5$Diff_1.1 = PP_5.5$PRE0_1 - PP_5.5$POST0_1

#PP_1.1$Diff = as.numeric(PP_1.1$PRE - PP_1.1$POST) #< einzelnes 1.1-dataset nur für pre-post-plot nötig
```

***

## Ausschluss von n = 190 Fällen mit Intervall-SDs == 0, danach N = 99810
...
#PP_1.1 = PP_1.1 %>% 
#  filter(ID %in% PP_5.5$ID) #< einzelnes 1.1-dataset nur für pre-post-plot nötig

#sum(PP_5.5$ID == PP_1.1$ID) #99810 - also IDs absolut gleich
PP_5.5$ID = 1:nrow(PP_5.5)
#PP_1.1$ID = 1:nrow(PP_1.1) #< einzelnes 1.1-dataset nur für pre-post-plot nötig
```
...
save(PP_1.1_ts, file = "Time Series Dataframes/k62_PP_1.1_ts.RData")

###

load("Time Series Dataframes/k62_PP_1.1_ts.RData")
...
ggsave("Time Series Dataframes/k62_PP_1.1_Pre-Post_Box_Violin.jpg", plot = Pre_Post_Box_Violin, width = 6, height = 4)
save(Pre_Post_Box_Violin, file = "Time Series Dataframes/k62_PP_1.1_Pre_Post_Box_Violin.RData")
...
ggsave("Time Series Dataframes/k62_PP_1.1_Pre-Post_Box_Violin_Mean+CI.jpg", plot = Pre_Post_Box_Violin_Mean_CI, width = 6, height = 4)
save(Pre_Post_Box_Violin_Mean_CI, file = "Time Series Dataframes/k62_PP_1.1_Pre_Post_Box_Violin_Mean_CI.RData")
```

```{r fig.align="center", out.width="75%"}
#knitr::include_graphics("Time Series Dataframes/k62_PP_1.1_Pre-Post_Box_Violin.jpg")
knitr::include_graphics("Time Series Dataframes/k62_PP_1.1_Pre-Post_Box_Violin_Mean+CI.jpg")
```
